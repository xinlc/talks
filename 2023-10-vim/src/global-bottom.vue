...
const growFollow = computed(() => formatter.value.growFollow === undefined ? true : formatter.value.growFollow)
const growDisable = computed(() => formatter.value.growDisable === undefined ? false : formatter.value.growDisable)
